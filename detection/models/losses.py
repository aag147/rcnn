# -*- coding: utf-8 -*-
"""
Created on Wed May  9 14:51:15 2018
...
def hoi_loss_cls(wp, wn=1, batch_size=1.0):
    def hoi_loss_cls_fixed_num(y_true, y_pred):
        return K.mean((wn*(1-y_true)+wp*(y_true))*K.binary_crossentropy(y_true, y_pred), axis=-1) / batch_size
