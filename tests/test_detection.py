...
if False:
    ...
    # DETECTION #
    # Convert deltas to rois and reduce with nms
    pred_anchors = helper.deltas2Anchors(x_class, x_deltas, cfg)
    pred_anchors = helper.non_max_suppression_fast(pred_anchors, cfg)
    pred_anchors = pred_anchors[:, 0: -1]
    # Filter rois and compute ground truths
    ...
    rois = filters_detection.prepareInputs(rois, imageDims)
